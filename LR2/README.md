...
## Завдання 2.3: РСкомпілюйте й запустіть тестову програму, щоб визначити приблизне
...
## Завдання 2.5: 
[cite_start]**Чи можна обійтися без лічильника команд (IP), використовуючи замість нього вершину стека?** [cite: 173]
* [cite_start]**Відповідь:** Заміна лічильника команд (IP) вершиною стека неможлива. IP необхідний для послідовного зчитування інструкцій із пам'яті, тоді як стек лише зберігає контекст та адреси повернення. Без IP процесор не знатиме, де шукати наступну команду для виконання.**Text**[cite: 12, 173].
---

# Індивідуальне завдання №12: Написання власного завантажувача ELF-файлів

[cite_start]В межах завдання було реалізовано завантажувач об'єктних файлів формату ELF для архітектури x86-64[cite: 187].
